...
export interface StaggeredMenuProps {
  ...
  actionButtons?: StaggeredMenuSocialItem[]
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div
            className="sm-logo flex items-center select-none pointer-events-auto text-primary "
            aria-label="Logo"
          >
            <span className="text-lg font-bold">Jatahin</span>
          </div>
        ...
        <aside
          ...
          ref={panelRef}
          className="staggered-menu-panel absolute top-0 right-0 h-full bg-background flex flex-col p-[6em_2em_2em_2em] overflow-y-auto z-10 backdrop-blur-[12px] pointer-events-auto"
        ...
        >
          <div className="sm-panel-inner flex-1 flex flex-col gap-5">
            ...
            {displaySocials && actionButtons && actionButtons.length > 0 && (
              <div
              ...
              >
                ...
                <ul
                  ...
                  role="list"
                >
                  {actionButtons.map((s, i) => (
                    <li key={s.label + i} className="sm-socials-item">
                      <a
                        href={s.link}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="sm-socials-link text-[1.2rem] font-bold text-[#111]  no-underline relative inline-block py-[2px] transition-[color,opacity] duration-300 ease-linear"
                      >
                        {s.label}
                      </a>
                    </li>
...
.sm-scope .sm-logo { pointer-events: auto; }
